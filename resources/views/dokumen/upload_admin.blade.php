@include('dokumen.form_upload.asal_surat')


<div class="form-group">
	<label class="col-sm-3 control-label">Actifity</label>
	<div class="col-sm-7">
		<select class="form-control select2 actifity" name="actifity" style="width: 90%;"></select>
...
<div class="form-group">
	...
	<div class="col-sm-7">
		<select class="form-control jenis_dokumen" name="jenis_dokumen" style="width: 90%;"></select> 
		<a href="{{url('data/insert-sub-jenis')}}"><i class="fa fa-fw fa-plus"></i></a>
	</div>
</div>

<div class="form-group">
	<label for="" class="col-sm-3 control-label">Kode Klasisfikasi</label>
	<div class="col-md-2">
...
<div class="form-group hide" id="pr_select">
	...
	<div class="col-sm-3	">
		<select class="form-control select_pr" name="pr" style="width: 90%;"></select>
	</div>
</div>
...
<div class="form-group hide" id="po_select">
	...
	<div class="col-sm-3	">
		<select class="form-control select_po" name="po" style="width: 90%;"></select>
	</div>
</div>
...
<div class="form-group hide" id="gr_select">
	...
	<div class="col-sm-3	">
		<select class="form-control select_gr" name="gr" style="width: 90%;"></select>
	</div>
</div>
...
<div class="form-group hide" id="cd_select">
	...
	<div class="col-sm-3	">
		<select class="form-control select_cd" name="cd" style="width: 90%;"></select>
	</div>
</div>

<div class="form-group">
		<label for="exampleInputFile" class="col-sm-3 control-label">File PDF</label>
		<div class="col-sm-9">
